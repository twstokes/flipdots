...
#define CMD_SEND_AND_REFRESH 0x83     // write buffer to a panel and commit immediately
#define CMD_SEND_NO_REFRESH 0x84      // write buffer to a panel, but don't commit until we send the refresh command (useful for painting all displays at the same time)
