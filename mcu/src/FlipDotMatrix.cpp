...
FlipDotMatrix::FlipDotMatrix(uint8_t mW, uint8_t mH, HardwareSerial *serial,
                             int baud)
    : Adafruit_GFX(mW, mH), FlipDotController(serial, baud), matrixWidth(mW),
      matrixHeight(mH) {}
...
/*
    ...
    see FlipDotController::sendBufferToPanel for information on immediate
   parameter
*/
